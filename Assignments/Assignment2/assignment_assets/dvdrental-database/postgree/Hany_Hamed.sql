...
-- NOTE:
--
-- File paths need to be edited. Search for /home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree and
...
\.
COPY actor (actor_id, first_name, last_name, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2163.dat';
...
\.
COPY address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2171.dat';
...
\.
COPY category (category_id, name, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2165.dat';
...
\.
COPY city (city_id, city, country_id, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2173.dat';
...
\.
COPY country (country_id, country, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2175.dat';
...
\.
COPY customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2177.dat';
...
\.
COPY film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2167.dat';
...
\.
COPY film_actor (actor_id, film_id, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2168.dat';
...
\.
COPY film_category (film_id, category_id, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2169.dat';
...
\.
COPY inventory (inventory_id, film_id, store_id, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2179.dat';
...
\.
COPY language (language_id, name, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2181.dat';
...
\.
COPY payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2183.dat';
...
\.
COPY rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2185.dat';
...
\.
COPY staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2187.dat';
...
\.
COPY store (store_id, manager_staff_id, address_id, last_update) FROM '/home/hany/repos/Uni_Courses/DMD2_Spring20IU/Assignments/Assignment2/assignment_assets/dvdrental-database/postgree/2189.dat';
...
--  ------------------------- Indexes of 1st Query -------------------------
CREATE INDEX staff_id_index_rental ON rental(staff_id);
CREATE INDEX rental_id_index_rental ON rental(rental_id);

-- CREATE INDEX customer_id_index_rental ON rental(customer_id, last_update);

CREATE INDEX customer_id_index_rental ON rental USING hash(customer_id);
CREATE INDEX last_update_index_rental ON rental(last_update);


CREATE INDEX payment_date_index_payment ON payment(payment_date);
CREATE INDEX rental_id_index_payment ON payment(rental_id);

CREATE INDEX customer_id_index_customer ON customer USING hash(customer_id);


--  ------------------------- Indexes of 2nd Query -------------------------
-- film: rental_rate, release_year, title

CREATE INDEX rental_rate_index_film ON film (rental_rate);
CREATE INDEX release_year_index_film ON film(release_year);
CREATE INDEX title_index_film ON film USING GIN(to_tsvector('english',title));

--  ------------------------- Indexes of 3rd Query -------------------------
-- film: film_id , rating
-- payment: amount , 
-- rental: rental_id , 
-- inventory: inventory_id , 
-- customer: first_name , customer_id
-- film_actor: actor_id
-- actor: first_name , actor_id

-- CREATE INDEX rental_rate_index_film2 ON film(rental_rate);
-- CREATE INDEX release_year_index_film2 ON film USING hash(release_year);
-- CREATE INDEX title_index_film2 ON film USING hash(title);


-- CREATE INDEX release_year_index_film2 ON film (release_year);
-- CREATE INDEX title_index_film2 ON film (title);